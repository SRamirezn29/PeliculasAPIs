    ...
    public class LocalDbDatabaseInitializer
    {
        ...
        public static ApplicationDbContext GetDbContextLocalDb(bool beginTransaction = true)
        {
            var options = new DbContextOptionsBuilder<ApplicationDbContext>()
                .UseSqlServer($"Data Source=(localdb)\\mssqllocaldb;Initial Catalog={_dbName};Intergrated Security"(
                    x => x.UseNetTopologySuit())
                .Options;
        ...
        static void DeleteDB()
        {
            ...
            {
                ExecuteCommand(Master,
                    $@"ALTER DATABSE [{_dbName}] SET SINGLE_USER WITH ROLLBACK IMMEDIATE; EXEC sp_detach_db'{_dbName}'");
        ...
        static void ExecuteCommand(string connetionString, string query)
        {
