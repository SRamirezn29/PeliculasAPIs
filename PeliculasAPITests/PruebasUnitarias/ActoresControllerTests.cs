...
namespace PeliculasAPITests.PruebasUnitarias
{
    public class ActoresControllerTests : BasePruebas
    {
        ...
        public async Task CrearActorSinFoto()
        {
            ...
            var actor = new ActorCreacionDTO() { Nombre = "Sebastian", FechaNacimiento = DateTime.Now };
            var mock = new Mock<IAlmacenadorArchivos>();
            mock.Setup(x => x.GuardarArchivo(null, null, null, null)).
                Returns(Task.FromResult("URL de prueba"));
        ...
        public async Task PatchRetorna404SiActorNoExiste()
        {
            ...
            var patchDoc = new Microsoft.AspNetCore.JsonPatch.JsonPatchDocument<ActorPatchDTO>();
            patchDoc.Replace(a => a.Nombre, "Nuevo nombre");
        ...
        public async Task PatchActualizarUnSoloCampo()
        {
            ...
            var actor = new Actor() { Nombre = "Sebastian", FechaNacimiento = fechaNacimiento };
            contexto.Add(actor);
            await contexto.SaveChangesAsync();
            ...
            var contexto3 = ConstruitContext(nombreBD);
